...
import com.readme.view.bysubject.BySubjectActivity
import com.readme.view.detail.ArticleDetailActivity
import kotlinx.android.synthetic.main.fragment_home.*

class HomeFragment : Fragment(), ArticleListAdapter.OnItemClickListener,
    SubjectListAdapter.OnItemClickListener {
    ...
    override fun onItemClickSubject(subjects: Subjects, itemView: View) {
        val i = Intent(context, BySubjectActivity::class.java);
        i.putExtra("id", subjects.id)
        i.putExtra("name", subjects.name)
        startActivity(i)
    }
